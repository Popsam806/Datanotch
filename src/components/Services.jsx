...
export default class Sercices extends React.Component {
  ...
  componentDidMount() {
    ...
    ScrollReveal().reveal(this.refs.image, leftAnimation);
    ScrollReveal().reveal(this.refs.group, rightAnimation);
  }
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 mt-16">
        <div className="mx-auto max-w-2xl lg:max-w-none">
          <div className="lg:flex lg:items-center lg:justify-end">
            <div className="flex justify-center lg:w-1/2 lg:justify-end lg:pr-12" ref='image'>
            ...
            <div>
              <ul role="list" className="text-base text-neutral-600 mt-16 lg:mt-0 lg:w-1/2 lg:min-w-[33rem] lg:pl-4" ref='group'>
